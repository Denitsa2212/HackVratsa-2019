...
/***/ function(module, exports, __webpack_require__) {
	...
	var _howler = __webpack_require__(1);
	
	var trashArr = ["paper", "banana skin", "napkins", "aluminium can", "food waste", "glass bottle", "motor oil can", "aluminum foil", "styrofoam containers", "waxed waterproof cardboard"];
	var recycle = ["aluminium can", "paper", "glass bottle", "aluminum foil"];
	var compost = ["banana skin", "food waste"];
	var waste = ["napkins", "motor oil can", "styrofoam containers", "waxed waterproof cardboard"];
	...
	//audio setup
	var savedAudio = new _howler.Howl({
	  src: ['./sounds/ball_saved.mp3']
	});
	
	var goalAudio = new _howler.Howl({
	  src: ['./sounds/goal.mp3']
	});
	...
	var restartHandler = function restartHandler() {
